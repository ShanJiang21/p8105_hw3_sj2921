...
# seperate the aisle into several levels for graphing
    rename(no_items = n) %>% 
    ggplot(aes(x = aisle, y = no_items, color = department)) + # plot the aisle point graph 
           geom_point() +
  ylim(0,20000) +
   viridis::scale_color_viridis(
    name = "aisle id",
...
* In general, there is an evident trend in that the climate gets warmer in recent decade than that in the 1980s. For 

Is there any observable / interpretable structure? Any outliers?
* But the summers are always hot in NY. There are some outliers in the graph. There are several different stations in each panel that recorded cooler tempreture than other stations. It is unclear whether this is due to machine error or other reasons.
